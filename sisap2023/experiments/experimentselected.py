...
from sisap2023.lib.similarity import getDists, l1_norm, l2_norm, relu, load_mf_encodings, load_mf_softmax
...
def experimentselected(encodings: str, softmax: str, output_path: str, number_of_categories_to_test: int, k: int, initial_query_index: int, thresh: float ):
